...
namespace backStage
{
    public partial class frmSingerInfo : Form
    {
        public frmSingerInfo()
        {
            InitializeComponent();
        }

        private void frmSingerInfo_Load(object sender, EventArgs e)
        {
        ...
        {
            frmAddSinger add = new frmAddSinger();
            add.panduan = 2;
            add.chuan = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            add.Show();
